...
PImage nube2;
float posXNube2, posYNube2, tamXNube2, tamYNube2, velNube2;
//BOTON INICIO
int tamXBotonInicio;
int tamYBotonInicio;
...
if (contador > 50 && contador < 250) {
tamTexto = map(contador, 50, 250, 5, 28);
} else {
tamTexto = 28;
}
textSize(tamTexto);
...
if (contador > 550 && contador < 700) {
tamXCars = map(contador, 550, 700, tamXCars, 0);
tamYCars = map(contador, 550, 700, tamYCars, 0);
}
image(cars, posXCars, posYCars, tamXCars, tamYCars);
//IF TRANS
if (contador>700 && contador<800) {
fill(0, 0, 0);
tamYRect1=map(contador, 700, 800, 0, height);
...
if (contador > 550 && contador < 700) {
tamXMate = map(contador, 550, 700, tamXMate, 0);
tamYMate = map(contador, 550, 700, tamYMate, 0);
}
//IF TRANS
if (contador>700 && contador<800) {
fill(0, 0, 0);
...
if (contador > 550 && contador < 700) {
tamXSully = map(contador, 550, 700, tamXSully, 0);
tamYSully = map(contador, 550, 700, tamYSully, 0);
}
//IF DH
if (contador>50 && contador<250) {
...
if (contador > 550 && contador < 700) {
tamXDh = map(contador, 550, 700, tamXDh, 0);
tamYDh = map(contador, 550, 700, tamYDh, 0);
}
//IF MATE 
if (contador>50 && contador<250) {
...
if (contador > 550 && contador < 700) {
tamXLuigi = map(contador, 550, 700, tamXLuigi, 0);
tamYLuigi = map(contador, 550, 700, tamYLuigi, 0);
}
//IF GUIDO
if (contador>50 && contador<250) {
...
if (contador > 550 && contador < 700) {
tamXGuido = map(contador, 550, 700, tamXGuido, 0);
tamYGuido = map(contador, 550, 700, tamYGuido, 0);
}
//IF TRANSICION PANTALLA
if (contador>700 && contador<800) {
fill(0, 0, 0);
...
if (contador > 550 && contador < 700) {
tamXCars2 = map(contador, 550, 700, tamXCars2, 0);
tamYCars2 = map(contador, 550, 700, tamYCars2, 0);
}
//IF CP
if (contador>50 && contador<250) {
...
if (contador > 550 && contador < 700) {
tamXCp = map(contador, 550, 700, tamXCp, 0);
tamYCp = map(contador, 550, 700, tamYCp, 0);
}
//IF TRANSICION PANTALLA
if (contador>700 && contador<800) {
fill(0, 0, 0);
